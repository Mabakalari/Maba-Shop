...
const app = express();
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
app.listen(() => console.log("Server started"));
//by : ! Pirt YT#1739
app.get("/", (req, res) => {
  res.send("By : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169")
})//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
let owner;
const updateAdmins = () => {//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
  owner = db.get("admins")
  owner.unshift('854305317549506592') //ايديك
}
updateAdmins()//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
let sv = '998263544783044709'//ابدي سرفرك
...
client.on("ready", () => {
  ...
  let textList = [`${prefix}stock` ,`${prefix}help`,"By : MABA KALARI᛫ ƉɆV̸ɨⱠ"] 
...
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
  ...
  } , 30000)//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
})
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
client.on('guildCreate', guild => {
  if (guild.id !== sv) return guild.leave()
})
client.login("MTAxMjM0MDI0NjgxMTI1NDc4NA.G5YM67.Sb2FKaiqQj5LV5WDUlHP_PKMWRnciFAcQk4LlY");
...
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
  ...
  const args = message.content
    ...
    .trim()
    .split(/ +/);//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
  ...
  if (message.content.startsWith(prefixx + "etprefix")) {
    ...
    message.channel.send(//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
let cooldown = false;
client.on("message", async message => {
  try {//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
//by : ! Pirt YT#1739
    if (command === "status") {
      if (!owner.includes(message.author.id)) return; //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
      if (!args[0]) return message.channel.send({
        embeds: [
          new Discord.MessageEmbed() //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
            .setAuthor(
            ...
            .setFooter(
              `Developed by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169 `,
              `https://media.discordapp.net/attachments/963889073766957187/969523671246991380/download.jpg`
            )
            .setColor(embColor)//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
            .setTimestamp()
...
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
      ...
      if (!tax)
        return message.channel.send({
          embeds: [
            new Discord.MessageEmbed() //by : Maba Kalari
              .setAuthor(
                message.author.username,
                message.author.displayAvatarURL({ dynamic: true })
              )//by : ! Pirt YT#1739
      ...
      db.set("accounts", data)//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
        ...
        return message.channel.send({
          embeds: [
            new Discord.MessageEmbed() //by : ! Pirt YT#1739
              ...
              .setFooter(
                `Developed by : ! Pirt YT#1739`,//by : ! Pirt YT#1739
                `https://media.discordapp.net/attachments/963889073766957187/969523671246991380/download.jpg`
              )
              .setColor(embColor)
              .setTimestamp()
...
//by : ! Pirt YT#1739
      ...
      user.send({
        embeds: [new Discord.MessageEmbed()
          ...
          .setDescription(//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
            `
...
`)
      ...
      message.channel.send(`<@${user.id}> **Check your Dm's Don't Forget Rate Us : <#956957365926756362> :white_check_mark:**`)
        ...
        client.channels.cache
          ...
          .send({
            embeds: [new Discord.MessageEmbed().setTitle(`${message.author.tag} gave ${numOfAcc} ${account} account to ${user.username}`)
              ...
              .setAuthor(
                message.author.username,
                message.author.displayAvatarURL({ dynamic: true })//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
              )
              .setTimestamp()//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
              .setFooter(
                `Developed by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169`,
                `https://media.discordapp.net/attachments/963889073766957187/969523671246991380/download.jpg`
              )
    ...
    if (command === "buy") {
      ...
      if (![message.channel.id, "all"].includes(buyId)) {
        message.reply("**Error,Please Go To Buying Room <#978260222462283786> :exclamation: **");
        return;
      }
      ...
      message.channel.send({ embeds: [buys] }).then(msg => {
        ...
        const filter = ({ content, author: { id } }) => {
          ...
          return content.startsWith(
            ...
            id === probotid &&//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
> **Total price : \`${tax * numOfAcc}\`**
         ...
         \`\`\` ${sentMail.join("\n")}\`\`\`
`)
              .setFooter(//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
                `Developed by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169`,
                `https://media.discordapp.net/attachments/963889073766957187/969523671246991380/download.jpg`
              )
              .setColor(embColor)
          ...
          message.reply("**Check your Dm's Don't Forget Rate Us : <#956957365926756362> :white_check_mark:**")
          msg.delete()//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
          ...
          .catch(err => {
            cooldown = false
            console.log(err)//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
            msg.delete()
      ...
      !cooldown && (cooldown = true)//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
    ...
    if (command === "setlog") {
      ...
      if (!owner.includes(message.author.id))
        return;
      let ch =//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
    ...
    if (command === "user-add") {
      ...
      let user =
        message.mentions.users.first() ||
        message.guild.members.cache.find(u => u.id === args[0]);//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
//by : ! Pirt YT#1739
    ...
    if (command.startsWith("remove-")) {
     ...
     //by : ! Pirt YT#17398
      ...
      if (!account)
        return message.channel.send(`> **:x: There are no accounts in the stock! **`); //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
      if (args[0] === "all") {
      ...
      data[data.indexOf(account)].emails = filtered //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
      db.set("accounts", data)
    ...
    if (command.startsWith("display-")) {
      const account = command.split("-")[1]
    //by : ! Pirt YT#1739
      if (message.channel.type === "dm") return; //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
      if (!owner.includes(message.author.id)) return; //by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
...
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169//by : MABA KALARI᛫ ƉɆV̸ɨⱠ#8169
